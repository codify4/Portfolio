...
const Hero = () => {
  ...
  return (
    <div id="hero" className="bg-black text-white">
        <HeroHighlight className="flex flex-row items-center justify-center text-6xl gap-[600px] xl:px-[100px] lg:px-[200px]">
          <div className="flex flex-col flex-wrap w-full items-start gap-y-3">
